...
import {
  ...
  mfaEnrollmentStatusResponseSchema,
...
const entries: Array<[string, Record<string, unknown>]> = [
  ...
  ['totpEnrollmentRequestJsonSchema', createJsonSchema(totpEnrollmentRequestSchema)],
  ['totpEnrollmentResponseJsonSchema', createJsonSchema(totpEnrollmentResponseSchema)],
  ['totpVerifyRequestJsonSchema', createJsonSchema(totpVerifyRequestSchema)],
  ['totpVerifyResponseJsonSchema', createJsonSchema(totpVerifyResponseSchema)],
  ['mfaVerifyRequestJsonSchema', createJsonSchema(mfaVerifyRequestSchema)],
  ['mfaVerifyResponseJsonSchema', createJsonSchema(mfaVerifyResponseSchema)],
  ['backupCodesResponseJsonSchema', createJsonSchema(backupCodesResponseSchema)],
  ['mfaEnrollmentStatusResponseJsonSchema', createJsonSchema(mfaEnrollmentStatusResponseSchema)],
  ['mfaDisableRequestJsonSchema', createJsonSchema(mfaDisableRequestSchema)],
