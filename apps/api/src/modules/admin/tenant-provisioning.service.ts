...
const DEFAULT_ROLES = [
  { name: 'super_admin', description: 'Platform-wide super admin access' },
...
const LEARNER_PERMISSIONS = ['users:read', 'campaigns:read', 'analytics:view'] as const;
...
const ensureBasePermissions = async (db: DatabaseClient): Promise<Map<string, string>> => {
  const basePermissions = [
    ...
    { resource: 'users', action: 'suspend', description: 'Suspend or reactivate user accounts' },
    ...
    { resource: 'campaigns', action: 'create', description: 'Create new training campaigns' },
    { resource: 'campaigns', action: 'delete', description: 'Delete training campaigns' },
    { resource: 'campaigns', action: 'start', description: 'Start training campaigns' },
    { resource: 'campaigns', action: 'stop', description: 'Stop training campaigns' },
    { resource: 'phishing', action: 'simulate', description: 'Run phishing simulations' },
    {
      resource: 'phishing',
      action: 'configure',
      description: 'Configure phishing simulation settings',
    },
    {
      resource: 'phishing',
      action: 'view_results',
      description: 'View phishing simulation results',
    },
    { resource: 'compliance', action: 'read', description: 'View compliance reports' },
    { resource: 'compliance', action: 'export', description: 'Export compliance data' },
    { resource: 'compliance', action: 'generate', description: 'Generate compliance reports' },
    ...
    { resource: 'integrations', action: 'write', description: 'Create and modify integrations' },
    ...
    { resource: 'analytics', action: 'view', description: 'View analytics dashboards' },
    { resource: 'analytics', action: 'export', description: 'Export analytics data' },
    { resource: 'sessions', action: 'observe', description: 'Observe user training sessions' },
    { resource: 'tenant', action: 'read', description: 'View tenant information' },
    { resource: 'tenant', action: 'write', description: 'Modify tenant settings' },
  ] as const;
