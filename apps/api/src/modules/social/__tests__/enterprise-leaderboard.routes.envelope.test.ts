...
describe('enterprise-leaderboard envelope', () => {
  ...
  describe('GET /api/v1/leaderboards/enterprise', () => {
    it('returns response with data wrapper', async () => {
      const { user } = await setupTenant();

      const response = await app.inject({
        method: 'GET',
        url: '/api/v1/leaderboards/enterprise',
        headers: {
  ...
  describe('GET /api/v1/leaderboards/enterprise/:leaderboardId', () => {
    it('returns response with data wrapper', async () => {
      const { user } = await setupTenant();

      const response = await app.inject({
        method: 'GET',
        url: '/api/v1/leaderboards/enterprise/00000000-0000-0000-0000-000000000000',
        headers: {
          authorization: `Bearer ${user.tokens.accessToken}`,
        },
      });
  ...
  describe('GET /api/v1/leaderboards/enterprise/:leaderboardId/me', () => {
    it('returns response with data wrapper', async () => {
      const { user } = await setupTenant();

      const response = await app.inject({
        method: 'GET',
        url: '/api/v1/leaderboards/enterprise/00000000-0000-0000-0000-000000000000/me',
        headers: {
          authorization: `Bearer ${user.tokens.accessToken}`,
        },
      });
  ...
  describe('GET /api/v1/leaderboards/enterprise/:leaderboardId/department/:deptId', () => {
    it('returns response with data wrapper', async () => {
      const { user } = await setupTenant();

      const response = await app.inject({
        method: 'GET',
        url: '/api/v1/leaderboards/enterprise/00000000-0000-0000-0000-000000000000/department/00000000-0000-0000-0000-000000000000',
        headers: {
          authorization: `Bearer ${user.tokens.accessToken}`,
        },
      });
  ...
  describe('GET /api/v1/leaderboards/enterprise/:leaderboardId/corporation/:corpId', () => {
    it('returns response with data wrapper', async () => {
      const { user } = await setupTenant();

      const response = await app.inject({
        method: 'GET',
        url: '/api/v1/leaderboards/enterprise/00000000-0000-0000-0000-000000000000/corporation/00000000-0000-0000-0000-000000000000',
        headers: {
          authorization: `Bearer ${user.tokens.accessToken}`,
        },
      });
  ...
  describe('GET /api/v1/leaderboards/enterprise/:leaderboardId/team/:teamId/summary', () => {
    it('returns response with data wrapper', async () => {
      const { user } = await setupTenant();

      const response = await app.inject({
        method: 'GET',
        url: '/api/v1/leaderboards/enterprise/00000000-0000-0000-0000-000000000000/team/00000000-0000-0000-0000-000000000000/summary',
        headers: {
          authorization: `Bearer ${user.tokens.accessToken}`,
        },
      });
